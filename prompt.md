...
-   **Conditional Logic & CPR:** The chatbot's suggestions must adapt based on the user's feedback. A key feature is the CPR Metronome.
    -   *Example:* *Bot:* "Is the person conscious and breathing?" -> *User clicks "No"* -> *Bot:* "Okay, we may need to start CPR. I can provide a metronome to guide the compressions. Would you like me to start it?"
